import 'package:delivery/controller/auth/verfiycodesignup_controller.dart';
          ...
          builder: (controller) => HandlingDataRequest(
              ...
              widget: Container(
                ...
                child: ListView(children: [
                  ...
                  InkWell(onTap: (){
                    controller.reSend() ;
                  },child: Center(child: Text("99".tr , style: TextStyle(color: AppColor.primaryColor1 , fontSize: 20 ),)),)
                ]),
              ))),
    );
  }
